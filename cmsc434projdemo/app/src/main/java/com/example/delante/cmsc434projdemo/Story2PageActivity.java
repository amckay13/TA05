...
public class Story2PageActivity extends AppCompatActivity {
    ...
    private static void setText(Resources res, int position){
        if (loc1.getLanguage().equals(rus.getLanguage())) {
            text1 = res.getStringArray(R.array.shapes_russian)[position];
        } else if (loc1.getLanguage().equals(spa.getLanguage())) {
            text1 = res.getStringArray(R.array.shapes_spanish)[position];
        } else {
            text1 = res.getStringArray(R.array.shapes_english)[position];
        }

        if (loc2.getLanguage().equals(rus.getLanguage())) {
            text2 = res.getStringArray(R.array.shapes_russian)[position];
        } else if (loc2.getLanguage().equals(spa.getLanguage())) {
            text2 = res.getStringArray(R.array.shapes_spanish)[position];
        } else {
            text2 = res.getStringArray(R.array.shapes_english)[position];
        }
    }
...
/*            final MediaPlayer mp = MediaPlayer.create(getContext(), sound_id);
            ...
            if (loc1.getLanguage().equals(rus.getLanguage())) {
                text1 = res.getStringArray(R.array.shapes_russian)[getArguments().getInt(ARG_SECTION_NUMBER)];
            } else if (loc1.getLanguage().equals(spa.getLanguage())) {
                text1 = res.getStringArray(R.array.shapes_spanish)[getArguments().getInt(ARG_SECTION_NUMBER)];
            } else {
                text1 = res.getStringArray(R.array.shapes_english)[getArguments().getInt(ARG_SECTION_NUMBER)];
            }

            if (loc2.getLanguage().equals(rus.getLanguage())) {
                text2 = res.getStringArray(R.array.shapes_russian)[getArguments().getInt(ARG_SECTION_NUMBER)];
            } else if (loc2.getLanguage().equals(spa.getLanguage())) {
                text2 = res.getStringArray(R.array.shapes_spanish)[getArguments().getInt(ARG_SECTION_NUMBER)];
            } else {
                text2 = res.getStringArray(R.array.shapes_english)[getArguments().getInt(ARG_SECTION_NUMBER)];
            }
