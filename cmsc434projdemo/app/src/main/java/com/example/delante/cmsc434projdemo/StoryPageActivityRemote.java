...
public class StoryPageActivityRemote extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story_page_remote);
       ...
       // setSupportActionBar(toolbar);
        ...
        videoScreen = (VideoView) findViewById(R.id.videoPlayer);
        videoScreen.setVideoURI(Uri.parse("android.resource://"+getPackageName()+"/"+ R.raw.mymovie));
